...
func BuildFromCreateAnnotationTemplateRequestDefault(req openapi.CreateAnnotationTemplateRequest) AnnotationTemplateBoInterface {
	annoTempId := uuid.New()
...
func BuildFromUpdateAnnotationTemplateRequestDefault(req openapi.UpdateAnnotationTemplateRequest) AnnotationTemplateBoInterface {
	var labelDoList []do.LabelDo
